...
<p align="center">
<img src="./src/main/webapp/images/Screenshot (241).png" alt="Password recovery screen requiring phone number to get OTP." width="500"/>
</p>
...
<p align="center">
<img src="./src/main/webapp/images/Screenshot (246).png" alt="User dashboard showing a welcome message, Total Dues, and a table of previous bill records." width="700"/>
</p>
...
<p align="center">
<img src="./src/main/webapp/images/Screenshot (247).png" alt="Pop-up view of the electricity bill showing service number, customer name, bill date, units consumed (40), and cost (120)." width="700"/>
</p>
A separate view provides the full summary before payment.
<p align="center">
<img src="./src/main/webapp/images/Screenshot (248).png" alt="Full bill view screen showing customer name, service number, billed units, dates, and payment ID." width="700"/>
</p>
...
<p align="center">
<img src="./src/main/webapp/images/Screenshot (242).png" alt="Screen with instructions for changing/linking mobile number requiring the service number (Scno)." width="700"/>
</p>
The system also allows for email updates using an OTP sent to the new address.
<p align="center">
<img src="./src/main/webapp/images/Screenshot (243).png" alt="Email processing system screen requiring Scno to update the email address using an OTP." width="700"/>
</p>
...
<p align="center">
<img src="./src/main/webapp/images/Screenshot (245).png" alt="Admin Login page with fields for admin name and admin password." width="500"/>
</p>
